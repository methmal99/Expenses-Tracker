...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Expenses Report by Date</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default" style="background-color: black">
					<div class="panel-heading">Expenses Report by Date</div>
    ...
    echo $msg;
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="date_reports_detailed.php" name="bwdatesreport">
