...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="color: aliceblue" >Summary</h1>
			</div>
		</div>
...
$sum_today_expense=$result['todaysexpense'];
 ?> 
						...
						<h4 style="color: aliceblue" >Today's Expense</h4>
...
$sum_weekly_expense=$result2['weeklyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color: aliceblue">Last 7day's Expense</h4>
...
$sum_monthly_expense=$result3['monthlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color: aliceblue">Monthly Expenses</h4>
...
$sum_yearly_expense=$result4['yearlyexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color: aliceblue">Annual Expenses</h4>
...
$sum_total_expense=$result5['totalexpense'];
 ?>
					<div class="panel-body easypiechart-panel">
						<h4 style="color: aliceblue">Total Expenses</h4>
